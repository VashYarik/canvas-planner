...
const anchorIdx = code.indexOf('bg-cream-card');
if (anchorIdx === -1) {
    console.error('Could not find anchor bg-cream-card');
    process.exit(1);
}

const returnIdx = code.lastIndexOf('    return', anchorIdx);
if (returnIdx === -1) {
    console.error('Could not find return statement before anchor');
    process.exit(1);
}
