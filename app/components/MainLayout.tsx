...
export default function Layout({ children }: { children: ReactNode }) {
    ...
    return (
        <div className="h-screen overflow-hidden bg-gray-50 flex flex-col md:flex-row">
            ...
            {/* Sidebar */}
            <aside
                className={`flex-shrink-0 bg-white border-r border-gray-200 p-6 flex flex-col overflow-y-auto fixed md:relative inset-y-0 left-0 z-50 transform transition-all duration-300 ease-in-out md:translate-x-0 md:w-64 ${sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full w-0 px-0'
                    }`}
            >
